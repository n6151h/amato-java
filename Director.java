/**
 * $Id: Director.java,v 1.9 2005/09/07 17:06:46 nicks Exp $
 * 
 ...
 *
 * Revision 1.8  2005/08/17 20:35:23  nicks
...
public class Director extends Constituent
{
    private static final long serialVersionUID = 20050722112740L;

    private String function = "director";

    public Director (HashMap aMap)
    {
	super (aMap);
    }
    ...
    public String toXML ()
    {
	String result = new String ("<director");
