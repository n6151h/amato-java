/**
 * $Id: HouseManager.java,v 1.5 2005/09/07 17:06:46 nicks Exp $
 * 
...
public class HouseManager extends Constituent
{
    private static final long serialVersionUID = 20050722112680L;

    private String function = "housemgr";

    public HouseManager (HashMap aMap)
    {
	super (aMap);
    }
    ...
    public String toXML ()
    {
	String result = new String ("<houseManager ");
